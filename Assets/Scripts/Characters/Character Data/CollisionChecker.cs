...
public class CollisionChecker : MonoBehaviour
{
    ...
    private void CheckGround(Vector2 colliderSize, Vector2 groundLeftOrigin, Vector2 groundRightOrigin)
    {
        ...
        Collider2D groundHit = Physics2D.OverlapArea(groundLeftOrigin, groundRightOrigin, groundLayer | undergroundLayer);
    ...
    private void CheckCeiling(Vector2 colliderSize, Vector2 headCeilingLeftOrigin, Vector2 headCeilingRightOrigin, float colliderSizeY)
    {
        ...
        RaycastHit2D leftHit = Physics2D.Linecast(headCeilingLeftOrigin, middleLeftOrigin, groundLayer | undergroundLayer);
        RaycastHit2D middleHit = Physics2D.Linecast(middleLeftOrigin, middleRightOrigin, groundLayer | undergroundLayer);
        RaycastHit2D rightHit = Physics2D.Linecast(headCeilingRightOrigin, middleRightOrigin, groundLayer | undergroundLayer);
